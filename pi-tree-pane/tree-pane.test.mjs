...
import { Container, HStack, ScrollView, VStack, stripTerminalSequences, visibleWidth } from "@earendil-works/pi-tui";
...
test("layout keeps Pi's transcript and dock, splits evenly and restores the original root", () => {
	...
	assert.equal(right.handleMouse({ type: "click" }), undefined);
	layout.scroll("end");
